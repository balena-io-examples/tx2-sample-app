STEPS FOR RUNNING THESE SAMPLE APPS FOR JETSON XAVIER Jetpack 4.2.1 (L4T 32.2)

CUDA 10 Samples:
---------------
1) Install NVidia SDK and download the packages for Jetson Xavier - Jetpack 4.2.1. Xavier needs to be selected as device and Jetpack 4.2.1 as release software. DO NOT flash the board using NVidia SDK.

2) Ensure you have a BalenaOS installed on the Xavier that is compatible with Jetpack 4.2.1. Xavier board needs to have been flashed previously with L4T 32.2, and this can be achieved using the "jetson-flash" tool from https://github.com/balena-os/jetson-flash .
